...
export class SubscriptionService {
  async create_subscription(app_id, subscription_data) {
    try {
  ...
  async get_subscriptions(app_id, options = {}) {
    try {
  ...
  async get_subscription_by_id(app_id, subscription_id) {
    try {
  ...
  async update_subscription(app_id, subscription_id, update_data) {
    try {
  ...
  async cancel_subscription(app_id, subscription_id, cancel_at_period_end = false) {
    try {
      const subscription = await prisma.subscription.findFirst({
        where: { id: subscription_id, app_id }
      });
